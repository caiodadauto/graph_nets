...
class RecurrentEdgeBlock(EdgeBlock):
  ...
  def _build(self, graph, prev_state, edge_model_kwargs=None):
    ...
    **kwargs: Optional keyword arguments to pass to the Sonnet module.
    ...
    collected_edges = self._collect_features(graph)
    updated_edges, next_state = self._edge_model(collected_edges, prev_state, **edge_model_kwargs)
...
class RecurrentNodeBlock(NodeBlock):
  ...
  def _build(self, graph, prev_state, node_model_kwargs=None):
    ...
    updated_nodes, next_state = self._node_model(aggregated_nodes, prev_state, **node_model_kwargs)
...
class RecurrentGlobalBlock(GlobalBlock):
  ...
  def _build(self, graph, prev_state, global_model_kwargs=None):
    ...
    **kwargs: Optional keyword arguments to pass to the Sonnet module.
    ...
    collected_globals = self._collect_features(graph)
    updated_globals, next_state = self._global_model(
            collected_globals, prev_state, **global_model_kwargs)
